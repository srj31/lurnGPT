    ...
    <>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Cardistry</div>
            <p className="text-xs text-muted-foreground">
              -20% from last month
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Guitar</div>
            <p className="text-xs text-muted-foreground">10 times this month</p>
          </CardContent>
        </Card>
      </div>
